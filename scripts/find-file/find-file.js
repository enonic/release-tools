...
const argv = yargs.command('find <token> <fileLocation> <repoNameRegExp> [contentRegExp]',
...
function doFilterRepo(repository, argv) {
    ...
    return repoNameMatched && argumentsCount === matchesCount;
}
